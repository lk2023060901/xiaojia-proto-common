...
const (
	...
	// 抖音主播客户端登录
	LoginType_LOGIN_TYPE_DOUYIN_ANCHOR LoginType = 3
	// 抖音小游戏
...
const file_login_type_proto_rawDesc = "" +
	"\n" +
	"\x10login_type.proto\x12\x06common*\x8e\x01\n" +
	"\tLoginType\x12\x13\n" +
	"\x0fLOGIN_TYPE_NONE\x10\x00\x12\x14\n" +
	"\x10LOGIN_TYPE_LOCAL\x10\x01\x12\x17\n" +
	"\x13LOGIN_TYPE_INTERNAL\x10\x02\x12\x1c\n" +
	"\x18LOGIN_TYPE_DOUYIN_ANCHOR\x10\x03\x12\x1f\n" +
